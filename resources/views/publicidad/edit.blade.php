...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('publicidad.update', $publicidad) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put')
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('fecha_cierre') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('fecha_cierre') ? ' is-invalid' : '' }}" name="fecha_cierre" id="input-fecha_cierre" type="datetime-local" placeholder="{{ __('fecha_cierre') }}" value="{{ old('fecha_cierre', date('Y-m-d\TH:m:s', strtotime($publicidad->fecha_cierre))) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('titulo') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('titulo') ? ' is-invalid' : '' }}" name="titulo" id="input-titulo" type="text" placeholder="{{ __('titulo') }}" value="{{ old('titulo', $publicidad->titulo) }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('Descripcion') ? ' has-danger' : '' }}">                      
                      <textarea class="form-control{{ $errors->has('Descripcion') ? ' is-invalid' : '' }}" name="Descripcion" id="input-Descripcion" rows="3" required="true" aria-required="true">{{ old('Descripcion', $publicidad->titulo) }}</textarea> 
